<div class="modal"  wire:ignore.self id="ModalNombre" tabindex="-1" role="dialog" data-backdrop="true">
    <div class="modal-dialog modal-sm z-depth-4 bordeado-x1" role="document">
      <div class="modal-content bordeado-x1">
        <div class="modal-header">
          <h5 class="modal-title">AGREGAR NUEVO NOMBRE</h5>

        </div>
        <div class="modal-body">

          <form wire:submit.prevent="updateNombre">
