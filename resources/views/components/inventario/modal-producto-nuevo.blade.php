<div class="modal" wire:ignore.self id="ProductoNuevo" tabindex="-1" role="dialog" data-backdrop="true">
            ...
            <div class="card" >
                ...
                <form  class="md-form" wire:submit.prevent="btnAddProducto">
                    ...
                    <div class="md-form my-0">
                        <select class="mdb-select md-form" searchable="Busque Aqui.." wire:model.defer="idProd">
                            <option value="" disabled selected>Elija una opción</option>
                            @foreach ($proPrincipales as $producto)
