...
<div class="tab-pane fade show active click" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"><a wire:click="addOpcion(1)" title="Suprema" class="d-flex align-items-center bg-white box_rounded p-2 mb-2 shadow-sm osahan-list pointer">
        ...
        </a><a wire:click="addOpcion(2)" title="Peperoni" class="d-flex align-items-center bg-white box_rounded p-2 mb-2 shadow-sm osahan-list pointer">
                    <div class="bg-light overflow-hidden box_rounded">
                    <img src="{{ asset("img/ico/24754753da.png") }}" class="img-fluid">
                    </div>
                    <div class="ml-2">
        ...
        </a><a wire:click="addOpcion(3)" title="Jamon" class="d-flex align-items-center bg-white box_rounded p-2 mb-2 shadow-sm osahan-list pointer">
                    <div class="bg-light overflow-hidden box_rounded">
                    <img src="{{ asset("img/ico/24754753da.png") }}" class="img-fluid">
                    </div>
                    <div class="ml-2">
