<div class="modal" wire:ignore.self id="ModalAddProveedor" tabindex="-1" role="dialog" data-backdrop="true">
...
<form wire:submit.prevent="btnAddProveedor">
...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0" style="color: #757575;">
            ...
            <div class="form-row my-0">
                <div class="col">
                    <div class="md-form">
                        <input type="text" id="contacto" class="form-control" wire:model.defer="contacto">
                        <label for="contacto">Contacto</label>
                    </div>
                </div>
                <div class="col">
                    <div class="md-form">
                        <input type="text" id="telefono_contacto" class="form-control" wire:model.defer="telefono_contacto">
