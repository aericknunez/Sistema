<div>
    ...
    @php
      $productAgregado = $productAgregado->sortBy('cod');
    ...
    <table class="table table-sm table-hover table-striped table-round">
        ...
        <tbody>
          ...
          @php
          $cod = $productAgregado->where('cod', $producto->cod);
          $cod->all();
          ...
          @endphp
          <tr class="tventas">
            <td class="text-center font-weight-bold pointer" data-toggle="modal" data-target="#ModalCantidadProducto" wire:click="selectCod({{ $producto->cod }}, 1)">{{ $cant }}</td>
