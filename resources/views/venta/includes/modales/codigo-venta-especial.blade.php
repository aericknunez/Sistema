<div class="modal" wire:ignore.self id="ModalCodigoVentaEspecial" tabindex="-1" role="dialog" data-backdrop="true">
    <div class="modal-dialog modal-sm z-depth-4 bordeado-x1" role="document">
      <div class="modal-content bordeado-x1">
        ...
        <div class="modal-body">
          ...
          <form wire:submit.prevent="validarCodigoVentaEspecial()">
