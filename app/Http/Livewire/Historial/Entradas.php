...
class Entradas extends Component
{
    ...
    {
        return view('livewire.historial.entradas');
    }
    ...
    public function aplicarFechas(){
        ...
        if ($this->tipo_fecha == 1) {
            $this->datos = $this->entradasSalidasUnica($this->fecha1);     
        } else {
            $this->datos = $this->entradasSalidasMultiple($this->fecha1, $this->fecha2);
        }
